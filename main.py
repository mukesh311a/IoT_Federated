...
def main():
    ...
    report = analyzer.generate_report([
        ("PQ-FL6G (Proposed)", "Vanilla FedAvg"),
        ("PQ-FL6G (Proposed)", "FedProx"),
        ("PQ-FL6G (Proposed)", "SCAFFOLD"),
        ("PQ-FL6G (Proposed)", "DP-FedAvg"),
        # Ablation Comparisons
        ("PQ-FL6G (Proposed)", "FL + Distributed Noise"),
        ("PQ-FL6G (Proposed)", "FL + Secure Aggregation"),
        ("PQ-FL6G (Proposed)", "FL + PQ Encryption Only")
    ])
